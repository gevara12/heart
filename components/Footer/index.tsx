        ...
        <Container maxWidth="lg">
          <Stack direction={'row'} alignItems={'center'} sx={{ mb: isMobile ? 4.5 : 6.5 }}>
            <Box>
              <Link href="/hero" passHref>
                <a style={{ display: 'block' }}>
                  <img
                    style={{ display: 'block', height: isMobile ? '34px' : '44px' }}
            ...
            <Typography
              ...
              sx={{ ml: isMobile ? 1.5 : isTablet ? 2 : 2.5, fontWeight: 500 }}
            >
              Heartapart
            </Typography>
            <Typography
          ...
          <Stack spacing={isMobile ? 2.5 : isTablet ? 4 : 5} direction={isMobile ? 'column' : 'row'}>
            {navigation.map((navLink, i) => (
              <Link href={navLink.url} passHref key={i}>
                <a style={{ color: theme.palette.text.secondary, textDecoration: 'none' }}>
                  <Typography variant={isMobile ? 'caption' : 'body1'} component={'div'} sx={{}}>
                    {navLink.title}
                  </Typography>
                </a>
              </Link>
            ...
            <Typography
              ...
              component={'div'}
              sx={{ color: theme.palette.text.secondary, marginLeft: isMobile ? 0 : 'auto' }}
            >
              © {year}, HeartApart
            </Typography>
          </Stack>
