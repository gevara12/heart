      ...
      <CardContent>
        ...
        <Stack direction="row" alignItems="center" sx={{ mb: 0.5 }}>
          <Stack direction="row" alignItems="center" sx={{ mr: 1 }}>
            ...
            <Typography variant="body1">{ratingAverage}</Typography>
          </Stack>
          <Link href={`https://www.airbnb.ru/rooms/${id}/reviews`} passHref>
            <a style={{ color: 'primary.main' }} target="_blank" rel="nofollow">
              <Typography variant="body1">{reviewCount} отзывов</Typography>
            </a>
          </Link>
        </Stack>
