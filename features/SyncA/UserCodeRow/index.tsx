		...
		<Stack direction={isMobile ? 'column' : 'row'} alignItems={isMobile ? 'flex-start' : 'center'} sx={{mt:3}}>
			...
			<Stack direction="row" alignItems="center">
				{ !currentUser
					...
					: (
						<>
							<Typography variant="body1" sx={{mr:3}}>{userKey}</Typography>
							{ navigator.clipboard &&
								<Tooltip PopperProps={{disablePortal:true}} open={open} title="Скопировано" placement={isMobile ? 'top' : 'right'} disableHoverListener>
