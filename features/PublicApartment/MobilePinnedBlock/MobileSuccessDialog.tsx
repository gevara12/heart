		...
		<Dialog onClose={handleClose} aria-labelledby="dialog-title" open={openDialog}>
			...
			<DialogTitle id="dialog-title">
				<Stack direction={'row'} alignItems={'start'}>
					...
					<IconButton aria-label="close" onClick={handleClose} size={'small'}><CloseIcon /></IconButton>
				</Stack>
			</DialogTitle>
			<DialogContent dividers>
				...
				<img style={{width:"100%"}} src="http://desktopwallpapers.org.ua/pic/201210/1920x1200/desktopwallpapers.org.ua-20397.jpg" alt=''/>
			</DialogContent>
		</Dialog>
	)
}