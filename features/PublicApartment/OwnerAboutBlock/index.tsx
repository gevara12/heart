    ...
    <>
      <Stack direction={{ xs: 'row-reverse', md: 'row' }} spacing={2} sx={{ mb: 1 }}>
        <Box sx={{ position: 'relative' }}>
          <Avatar
            sx={{ bgcolor: grey[300], width: { xs: 40, md: 70 }, height: { xs: 40, md: 70 }, position: 'relative' }}
          >
          ...
          <Stack direction={'row'} alignItems={'center'} spacing={1}>
            ...
            <Typography sx={{ color: 'primary.main' }}>
              <Link href={owner?.refAbb + '#user-profile-review-tabs'} passHref>
                <a target="_blank" style={{ color: 'inherit' }} rel="noopener noreferrer">
                  на сервисе A
                </a>
              </Link>
            </Typography>
