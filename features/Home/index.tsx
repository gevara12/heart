...
const bigCardsList = [
  {
    title: 'Будьте в ТОПе, это бесплатно',
    desc: 'Нет комиссий и платы за размещение, объявление ранжируется в поиске, согласно подтвержденному рейтингу.',
    image: '/images/home/ObjectsTop.png',
  },
  {
    title: 'Безопаность личных данных',
    desc: 'Ваша личная информация бережно хранится на серверах в РФ со строгим соблюдением законодательства.',
    image: '/images/home/PersonalData.png',
  },
];
