...
export default function PromoBigCard({card}:any) {
    ...
    return (
        <Box sx={{ background:background, borderRadius:'20px', p:3, height:'100%' }}>
            <Box sx={{ background:gradient.main, borderRadius:'20px', overflow:'hidden', height:isMobile?'168px':'300px' }}>
                <img style={{ display:'block', width:isMobile?168:366, margin:isMobile ? '46px auto' : '36px auto' }} src={card.image} alt={''}/>
            </Box>
