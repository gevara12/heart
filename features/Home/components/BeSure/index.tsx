  ...
  return (
    ...
    >
      <Container fixed>
        ...
        <Typography
          variant={isSmBreak ? 'body2' : 'body1'}
          sx={{
            maxWidth: '744px',
            margin: isMdBreak ? '8px auto 0' : '20px auto 0',
          }}
        >
          Подтверждается подлинность перенесенных данных и тот факт, что пользователь нашего сервиса действительно имеет
          доступ к объявлениям в профиле на внешнем сервисе.
        </Typography>
        <Box sx={{ position: 'relative', marginTop: isMdBreak ? 4.5 : 6.5 }}>
          <img
            style={{
              ...commonStyles,
              width: isLgBreak ? 40 : 60,
              top: isLgBreak ? 74 : 84,
              left: isLgBreak ? 130 : 350,
            }}
            src={'/images/home/BeSure/PremiumLabel.png'}
            alt={''}
          />
          <img
            style={{
              ...commonStyles,
              width: isLgBreak ? 180 : 262,
              top: isLgBreak ? 239 : 389,
              left: isLgBreak ? 24 : 224,
              boxShadow: boxShadow,
            }}
            src={'/images/home/BeSure/Confirmation.png'}
            alt={''}
          />
          <img
            style={{ display: 'inline-block', width: isLgBreak ? 160 : 260 }}
            src={'/images/home/BeSure/Mobile_Mockup.png'}
            alt={''}
          />
          <img
            style={{
              ...commonStyles,
              width: isLgBreak ? 120 : 160,
              top: isLgBreak ? 44 : 114,
              right: isLgBreak ? 118 : 328,
              boxShadow: boxShadow,
            }}
            src={'/images/home/BeSure/TopserviceLabel.png'}
            alt={''}
          />
          <img
            style={{
              ...commonStyles,
              width: isLgBreak ? 180 : 332,
              top: isLgBreak ? 185 : 265,
              right: isLgBreak ? 32 : 120,
              boxShadow: boxShadow,
            }}
            src={'/images/home/BeSure/Message.png'}
            alt={''}
          />
        </Box>
      </Container>
