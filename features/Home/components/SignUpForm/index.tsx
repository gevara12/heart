...
import { Box, Button, Stack, FormControl, TextField, InputLabel, OutlinedInput, InputAdornment, IconButton, FormHelperText } from '@mui/material';
...
export default function SignUpForm() {
    ...
    const handleSubmit = React.useCallback(async () => {
        try {
            ...
            dispatch(
                showSnackbar({ message: 'Вы успешно зарегистрированы', severity: SeverityEnum.success }),
            );
        } catch (error) {
            console.error(error);
        }
