    ...
    return (
        <Container maxWidth='lg'>
            <Box sx={{textAlign:'center', padding:isMobile? '52px 0':'194px 0 255px', position:'relative'}}>
                <img style={{display:isMobile?'none':'block', position:'absolute',  left: '0', top: '69px', boxShadow: '0px 4px 24px rgba(46, 60, 80, 0.08)'}} src={'/images/home/HomeHero/Rating.png'} alt={''}/>
                <img style={{display:isMobile?'none':'block', position:'absolute',  left: '78px', top: '474px', boxShadow: '0px 4px 24px rgba(46, 60, 80, 0.08)'}} src={'/images/home/HomeHero/Rules.png'} alt={''}/>
                <img style={{display:isMobile?'none':'block', position:'absolute',  right: '0', top: '425px', boxShadow: '0px 4px 24px rgba(46, 60, 80, 0.08)'}} src={'/images/home/HomeHero/Message.png'} alt={''}/>
