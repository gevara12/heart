        ...
        <Container maxWidth='lg'>
            <Box sx={{overflow:'hidden',marginTop:isMobile? '52px':'104px', background: 'linear-gradient(90deg, #F3E7E9 0%, #E3EEFF 99%, #E3EEFF 100%)', borderRadius: '20px', padding:isMobile?'52px 24px':'60px 24px'}}>
                <Stack direction={isMobile ? 'column':'row'} alignItems={isMobile?'flex-start':'center'} justifyContent={'center'}>
                    <Box sx={{flex:'1 1 50%'}}>
                        <Typography variant={isMobile? 'h6':'h4'} sx={{fontWeight:500}}>Узнавайте о новых релизах в числе первых <img style={{display:isMobile?'none':'inline',verticalAlign: 'middle'}} src={'/images/home/JoinUs/Telegram.png'} alt={''}/></Typography>
                        ...
                        <Stack direction={'row'} alignItems={'center'} sx={{mt:isMobile?'20px':'32px'}}>
                            <Link href={'https://t.me/%20XsyLZklmE1VkOWQ6'} passHref>
                            ...
                            <img style={{display:isMobile?'block':'none'}} src={'/images/home/JoinUs/Telegram.png'} alt={''}/>
                        </Stack>
                    </Box>
                    <Box sx={{flex:'1 1 50%', textAlign:'center', position:'relative'}}>
                        <img style={{display:isMobile?'none':'block', position:'absolute', left: '12px', top: '14px'}} src={'/images/home/JoinUs/Magic_Wand.png'} alt={''}/>
                        <img style={{display: 'inline-block', width:isMobile?'160px':'260px', marginTop:isMobile?'40px':'0', marginBottom:isMobile?'0':'-152px'}} src={'/images/home/JoinUs/MokupSocial.png'} alt={''}/>
                    </Box>
                </Stack>
            </Box>
        </Container>
